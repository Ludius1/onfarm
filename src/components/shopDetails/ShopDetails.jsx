  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      try {
        ...
        setProduct(response.data);
        if (
          response.data.prdDetailsId &&
          response.data.prdDetailsId.src.length > 0
        ) {
          ...
          <div className="left-shop__details">
            <div className="left__shopdetails">
              <div className="top__shopdetails">
                ...
                <span className="left__header__text__shopdetails">
                  <span>
                    Brands:<small>{product.brandName}</small>
                  </span>
                  <small>
              ...
              <div className="product__dec__details">
                ...
                <div className="product__dec__detai">
                  <small className="product__dec_price">
                    ${product.price}.00
                  </small>
                  ...
                  <div className="quantity__sect">
                      ...
                      <small>
                        ...
                        <span className="value">
                          <input
                            type="text"
                            value={countOrder}
                            onChange={handleCountOrder}
                          />
                        </span>
                        <span onClick={handleAdd} className="Addition">
                          <GoPlus />
                        </span>
                      </small>
                    ...
                    <small>
                      <CiHeart className="quatoty__heart" />
                  ...
                  <div className="product__detail__down">
                    <small className="product__other__detail">
                      <span>
                        Availability:{" "}
                        <small>{product.NumberLeft} Instock</small>
                      </span>
                      <span>
                        Categories: {product.prdCategoryId?.prodSubCartigory}
                      </span>
            ...
            <div className="left__shopdetails__additional">
              <div className="top__left__shopdetails__">
                ...
                <span className="active--decs">
                  REVIEWS (<small>1</small>)
                </span>
              </div>
              ...
              <div className="more__product__details_">
                ...
                <div className="imgPro">
                  <span>
                    ...
                    <small onClick={() => setshowIfrane(!showIfrane)}>
                      {" "}
                  ...
                  <div
                    className={`showIframe ${
                      showIfrane ? "nowshowIframe" : ""
                    }`}
                  >
                    <iframe
                      src={product.productYoutubeLink}
                    ...
                    <small
                      className="imes__i"
                      onClick={() => setshowIfrane(!showIfrane)}
                    >
                      <TiTimes className="imes__ifra" />{" "}
                    </small>
                  </div>
                </div>
              </div>
              ...
              <div className="products__supreme__qulai">
                ...
                <small>
                  <div
                    dangerouslySetInnerHTML={{
                      __html: product.productSupremeQualityDetails,
                    }}
                  />
                </small>
              </div>
            ...
            <div className="top__right__shop__dets">
              <span>
                <small>
                  ...
                  <span>Free shipping apply to all orders over $90</span>
                </small>

                <small>
                  <GoShieldCheck className="icon__side__right" />
                  <span>Guaranteed 100% Organic from nature farms</span>
                </small>
                <small className="nono__">
                  <HiOutlineReceiptRefund className="icon__side__right" />
                  <span>60 days returns if you change your mind</span>
                </small>
              </span>
            </div>
